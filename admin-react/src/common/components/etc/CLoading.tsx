...
export default function CLoading({ loading, children } : {
	loading: boolean
	...
	return <div>{
		loading ? <div className={'relative'}>
			...
			<div className={'absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20'}>
				<div role="status">
					<svg aria-hidden="true" className={`w-8 h-8 text-gray-100 animate-spin dark:text-gray-400 fill-blue-600`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">

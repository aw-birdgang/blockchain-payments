...
contract BIRDGANG is ERC20, ERC20Burnable, ERC20Snapshot, Ownable, Pausable, ERC20Permit, ERC20Votes, ERC20FlashMint {

    uint256 public totalMintAmount = 0;
    uint256 public totalBurnAmount = 0;

    constructor() ERC20("BIRDGANG", "BGT") ERC20Permit("BIRDGANG") {

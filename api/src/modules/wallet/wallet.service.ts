...
export class WalletService {
  ...
  async updateName(id: string, name: string): Promise<Wallet> {
    try {
  ...
  async findDepositAddressByWalletIdAndDepositAddressId(
    walletId: string,
    ...
    const results = await builder
      .where('deposit_address.walletId = :walletId', { walletId: walletId })
      .where('deposit_address.depositAddressId = :depositAddressId', {
